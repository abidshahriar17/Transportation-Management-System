...
<body> 
    ...
    <div class="payment_option">
        ...
        <form action="../controller/add_job_entry_controller.php" method="post" id="addtransport">
            ...
            <div style = "position:absolute; left:250px; top: 150px">
                    <label for="Post"><span style="color:#000000" class="p1">Post</span></label>
                    <input type="text" name="Post" id="Post" placeholder="Enter post for the job" autocomplete="off">
            </div>
            <div style = "position:absolute; left:250px; top: 220px">
                    <label for="Age_requirement"><span style="color:#000000" class="p1">Age requirement</span></label>
                    <input type="text" name="Age_requirement" id="Age_requirement" placeholder="Enter age requirement for the job" autocomplete="off">
            </div>
            <div style = "position:absolute; right:250px; top: 80px">
                    <label for="Educational_Qualification"><span style="color:#000000" class="p1">Educational Qualification</span></label>
                    <input type="text" name="Educational_Qualification" id="Educational_Qualification" placeholder="Educational_Qualification" autocomplete="off">
            </div>
