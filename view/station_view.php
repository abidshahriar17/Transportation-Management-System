...
<body>
    <div class="payment_option">
        <div class="Text">
            <h1>Find your nearby Station/Stands/Ports</h1>
        </div>
        <table>
		<tr>
            <th>Rail Stations</th>
            ...
            <tr>
                ...
                foreach ($_SESSION['rail_station'] as $station) {
                ...
                <td>
                <?php 
                foreach ($_SESSION['bus_stand'] as $stand) {
                    echo $stand['stand'] . '<br>';
                } 
                ?>
                </td>
                ...
                <td>
                <?php 
                foreach ($_SESSION['launch_port'] as $port) {
                    echo $port['port'] . '<br>';
                } 
                ?>
                </td>
                ...
                <td>
                <?php 
                foreach ($_SESSION['airport'] as $port) {
                    echo $port['port'] . '<br>';
                }
                ?>
                </td>
