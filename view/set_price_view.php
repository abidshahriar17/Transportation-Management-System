...
<body> 
    ...
    <div class="payment_option">
        ...
        <form action="../controller/set_price_entry_controller.php" method="post" id="addtransport">
            ...
            <div style = "position:absolute; right:630px; top: 150px">
            ...
            <div style = "position:absolute; right:580px; top: 220px">
                    <label for="Set_price"><span style="color:#000000" class="p1">Set price</span></label>
                    <input type="text" name="Set_price" id="Set_price" placeholder="Price" autocomplete="off">
            </div>
