...
<body> 
    ...
    <div class="site-logo">
		<form action="../controller/apply_job_entry_controller.php" method="post" id="regForm">		
			<div class="reg-From-form">
                <div class="reg-form-control-single">
					<label for="job_id"><p style="color:#000000" class="p1">Job ID</p></label>
					<input type="text" name="job_id" id="job_id" placeholder="Enter Job ID" autocomplete="on">
				</div>
				<div class="reg-form-control-single">
				...
				<div class="login-form-control-single">
					<label for="Age"><p style="color:#000000" class="p1">Age</p></label>
					<input type="int" name="Age" id="Age" placeholder="Enter your age" autocomplete="off">
				</div>
				<div class="reg-form-control-single">
					<label for="Gender"><p style="color:#000000" class="p1">Gender</p></label>
					<input type="text" name="Gender" id="Gender" placeholder="Enter your gender" autocomplete="off">
				</div>
				<div class="reg-form-control-single" style="width: 50%;">
					<label for="Educational_Qualification"><p style="color:#000000" class="p1">Educational Qualification</p></label>
					<input type="text" style="width: 100%;" name="Educational_Qualification" id="Educational_Qualification" placeholder="Type your Educational Qualification" autocomplete="off">
				</div>
				<div class="reg-form-control-single">
					<label for="Present_Address"><p style="color:#000000" class="p1">Present Address</p></label>
					<input type="text" name="Present_Address" id="Present_Address" placeholder="Enter your Present Address" autocomplete="off">
				</div>
				<div class="reg-form-control-single">
					<label for="Permanent_Address"><p style="color:#000000" class="p1">Permanent Address</p></label>
				...
				<div class="reg-form-control-single">
				<button class="reg-form-submit-btn" type="submit">Apply</button>
				</div>
			</div>
		</form>
