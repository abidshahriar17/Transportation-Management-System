...
<body> 
    ...
    <div class="payment_option">
        ...
        <form action="../controller/manage_seat_entry_controller.php" method="post" id="addtransport">
            ...
            <div style = "position:absolute; right:580px; top: 220px">
                    <label for="Available_seats"><span style="color:#000000" class="p1">Available seats</span></label>
                    <input type="text" name="Available_seats" id="Available_seats" placeholder="Enter number of available seats" autocomplete="off">
            </div>
            <div class="login-form-control-single" style = "position:absolute; right:620px; top: 310px">
