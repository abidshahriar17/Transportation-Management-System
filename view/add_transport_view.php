...
<body> 
    ...
    <div class="payment_option">
        ...
        <form action="../controller/add_transport_entry_controller.php" method="post" id="addtransport">
            <div style = "position:absolute; right:550px; top: 80px">
            ...
            <div style = "position:absolute; right:580px; top: 150px">
            ...
            <div style = "position:absolute; right:580px; top: 220px">
                    <label for="Seat"><span style="color:#000000" class="p1">Total seat</span></label>
                    <input type="text" name="Total_seat" id="Total_seat" placeholder="Enter name of the transport" autocomplete="off">
            </div>
            <div style = "position:absolute; right:580px; top: 290px">
                    <label for="Name"><span style="color:#000000" class="p1">Name</span></label>
                    <input type="text" name="Name" id="Name" placeholder="Enter name of the transport" autocomplete="off">
            </div>
