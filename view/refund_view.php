...
<div class="payment_option">
        ...
        <div>
            <form action="../controller/refund_entry_controller.php" method="post" id="regForm">
                <table>
                    <tr>
                        <th>Mobile Number</th>
                        <th>Password</th>
                    ...
                    <tr>
                        ...
                        <td>
                        <input type="text" name="Ticket_Number" id="Ticket_Number" placeholder="Enter your Ticket Number" autocomplete="on">
                        </td>
                ...
                <div style = "position:absolute; left:617px; top: 200px">
