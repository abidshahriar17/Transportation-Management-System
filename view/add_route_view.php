...
<body> 
    ...
    <h3> <span style="color:#000000" class="p1"> 
    <?php 
    require_once("../controller/connection.php"); 
    echo $_SESSION['full_name'];?> 
    </span> </h1> <button type="submit"><a href="../controller/login2_controller.php">Logout</button></a></span><br>		
    </div>
    ...
    <div class="payment_option">
        ...
        <form action="../controller/add_route_entry_controller.php" method="post" id="addtransport">
            <div style = "position:absolute; left:250px; top: 80px">
                    <label for="class"><span style="color:#000000" class="p1">Choose the transportation</span></label>
                    <select name="Choose_the_transportation" id="Choose_the_transportation" class="Choose_the_transportation">
                                            <option value="">Choose the transportation</option>
            ...
            <div style = "position:absolute; left:250px; top: 150px">
                    <label for="ID"><span style="color:#000000" class="p1">ID</span></label>
                    <input type="text" name="ID" id="ID" placeholder="Enter ID of the transport" autocomplete="off">
            </div>
            <div style = "position:absolute; left:250px; top: 220px">
                    <label for="Departure_Time"><span style="color:#000000" class="p1">Departure Time</span></label>
                    <input type="text" name="Departure_Time" id="Departure_Time" placeholder="Enter time of deparature" autocomplete="off">
            </div>
            <div style = "position:absolute; right:250px; top: 80px">
                    <label for="From"><span style="color:#000000" class="p1">From</span></label>
                    <input type="text" name="From" id="From" placeholder="From" autocomplete="off">
            </div>
            <div style = "position:absolute; right:250px; top: 150px">
                    <label for="Arrival_Time"><span style="color:#000000" class="p1">Arrival Time</span></label>
                    <input type="text" name="Arrival_Time" id="Arrival_Time" placeholder="Enter time of arrival" autocomplete="off">
            </div>
            <div style = "position:absolute; right:250px; top: 220px">
                    <label for="To"><span style="color:#000000" class="p1">To</span></label>
                    <input type="text" name="To" id="To" placeholder="To" autocomplete="off">
            </div>
            <div class="login-form-control-single" style = "position:absolute; right:620px; top: 380px">
				<button class="login-form-submit-btn" type="submit"> Submit</button>
			</div>
