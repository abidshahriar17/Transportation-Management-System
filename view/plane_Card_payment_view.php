...
<head>
    ...
    <link rel="stylesheet" href="../view/Cardpayment.css">
    <style>
        body{
    margin: 0;
    padding: 0;
...
.header{
    background-color: rgb(86, 179, 215);
    display: flex;
    align-items: center;
    left: 200px;
}
...
<body>
    <form action="../controller/plane_payment_entry_controller.php" method="post">
        <div class="parent">
            <img src="../view/download (1).png" class="mastercard" alt="">
            <div class="child">
                <p>Card number</p>
                <div class="input">
